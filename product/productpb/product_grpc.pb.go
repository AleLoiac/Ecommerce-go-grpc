...
type ProductServiceClient interface {
	AddProduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*Product, error)
...
func (c *productServiceClient) AddProduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
...
type ProductServiceServer interface {
	AddProduct(context.Context, *CreateProductRequest) (*Product, error)
...
func (UnimplementedProductServiceServer) AddProduct(context.Context, *CreateProductRequest) (*Product, error) {
...
func _ProductService_AddProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).AddProduct(ctx, req.(*CreateProductRequest))
	}
